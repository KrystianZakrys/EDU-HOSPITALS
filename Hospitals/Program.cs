...
using Hospitals.Infrastructure.Repository;
...
builder.Services.AddScoped(sp =>
{
    ...
    return mongoClient.GetDatabase("hospitals");
});

builder.Services.AddScoped<IHospitalRepository<Hospital>, HospitalRepository>();
